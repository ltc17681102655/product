...
import com.liyou.service.estate.entity.keys.HouseDealBuildingKey;
 ...
 */
@Entity
@Table(name = "house_deal_building_analysis")
@IdClass(HouseDealBuildingKey.class)
public class HouseDealBuildingAnalysisEntity implements Serializable {
    /**
     * 城市ID
     */
    @Id
    ...
    public String toString() {
        return "HouseDealBuildingAnalysisEntity{" +
                "cityId=" + cityId +
                ", houseId=" + houseId +
                ", building='" + building + '\'' +
                ", dealCnt=" + dealCnt +
