...
@Entity
@Table(name = "city_diff_deal_totalprice_dist")
@IdClass(CityDealTotalpriceDistEntityPK.class)
public class CityDealTotalpriceDistEntity implements Serializable {
    private int cityId;
    private int isFirst;
