 ...
 */
@Entity
@Table(name = "district_diff_deal_totalprice_dist")
@IdClass(DistrictDealTotalpriceDistEntityPK.class)
public class DistrictDealTotalpriceDistEntity implements Serializable {
    private int cityId;
    ...
    private CityTotalpriceRangeConfigEntity cityTotalpriceRangeConfigEntity;
    ...
    @JoinColumns({
            @JoinColumn(name = "totalprice_id", referencedColumnName = "periodid", insertable = false, updatable = false)
    })
    @NotFound(action = NotFoundAction.IGNORE)
    public CityTotalpriceRangeConfigEntity getCityTotalpriceRangeConfigEntity() {
        return cityTotalpriceRangeConfigEntity;
    }

    public void setCityTotalpriceRangeConfigEntity(CityTotalpriceRangeConfigEntity cityTotalpriceRangeConfigEntity) {
        this.cityTotalpriceRangeConfigEntity = cityTotalpriceRangeConfigEntity;
    }
}
